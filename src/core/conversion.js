...
const Conversion = {
  ...
  convertFloatToString(float, decimals) {
    return Conversion.convertFloatToBN(float, decimals).toString();
  },
  ...
  convertFloatToBN(value, decimals) {
    ...
    return scalingFactor.isNeg()
      ? inflatedValueBN.div(Conversion.BN_TEN.pow(scalingFactor))
      : inflatedValueBN.mul(Conversion.BN_TEN.pow(scalingFactor));
  },

  convertBNtoFloat(bigNumber, decimals) {
    return Conversion.convertStringToFloat(bigNumber.toString(), decimals);
  },
